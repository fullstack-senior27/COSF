...
class _$_Filters implements _Filters {
  ...
  @override
  String toString() {
    return 'Filters(search: $search, location: $location, date: $date, avgRating: $avgRating, priceRange: $priceRange, serviceType: $serviceType, serviceCategory: $serviceCategory)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, search, location, date,
      avgRating, priceRange, serviceType, serviceCategory);
